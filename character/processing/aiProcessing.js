...
let debug, messageProcessing, ui, threadData, debugData, config, errors = [];
try {
  ...
  config = globalsResult.globals?.config;
...
if (errors.length > 0) {
  throw new Error("aiProcessing failed to import: " + errors.join("; "));
}
